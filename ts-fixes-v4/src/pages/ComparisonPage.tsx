            ...
            <div className={`rounded-xl border overflow-hidden ${theme === 'dark' ? 'border-dark-border' : 'border-light-border'}`}>
              ...
              {Object.keys(watch1.specs ?? watch1.specifications ?? {}).map((key, i) => (
                ...
                >
                  ...
                  <span className="text-center font-medium">{(watch1.specs ?? watch1.specifications)?.[key]}</span>
                  <span className="text-center font-medium">{(watch2.specs ?? watch2.specifications)?.[key] || '-'}</span>
                </div>
              ))}
            </div>
          </section>
