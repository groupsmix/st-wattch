          ...
          <div className={`rounded-xl border overflow-hidden mb-8 scroll-reveal ${
            ...
            <table className="w-full">
              ...
              <tbody>
                ...
                {Object.keys(watch1.specs ?? watch1.specifications ?? {}).map((key, i) => (
                  <tr key={key} className={i % 2 === 0
                    ...
                    <td className="px-4 py-2 text-center text-xs">{(watch1.specs ?? watch1.specifications)?.[key] || '-'}</td>
                    <td className="px-4 py-2 text-center text-xs">{(watch2.specs ?? watch2.specifications)?.[key] || '-'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
